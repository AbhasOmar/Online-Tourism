...
<div class="container">
	<div class="row">
		...
		<div class="col-md-4 img">
			 <a href="#"><section style="background-image:url('images/himalays.jpg'); background-size: 100% 100%; height: 375px;margin-top: 10%;">
		...
		<div class="col-md-4 img">
			 <a href="#"><section style="background-image:url('images/fest.png'); background-size: 100% 100%; height: 375px;margin-top: 10%;">
...
<div class="container-fluid" style="background-color: #150b56;margin-top: 50px;height: 450px;">
	<div class="row">
		...
		<div class="col-md-5">
			<section style="background-image:url('images/beauty.jpeg'); background-size: 100% 100%; height: 350px;margin-top: 50px;">
		</div>	
	</div>
</div>
		...
		<div class="col-md-12">
			<div class="col-md-7">
				...
				<div class="col-md-6 round" style="margin-top: 8%;">
					<a href="#">
						<img class="round" src="images/dharamshala.jpg" alt="Avatar" style="width:150px;float:left;">&nbsp;
						<p style="font-size: 12px;color: white;padding-left: 60%;"><b style="font-size: 20px">Dharamshala</b><br>Read more</p>
					</a>
				</div>
				<div class="col-md-6 round" style="margin-top: 8%;">
					<a href="#">
						<img class="round" src="images/chamba.jpg" alt="Avatar" style="width:150px;float:left;">&nbsp;
